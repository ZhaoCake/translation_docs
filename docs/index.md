...
### [Hotpot / Fennel 文档](hotpot/hotpot_nvim_readme.md)

源文档：[https://github.com/rktjmp/hotpot.nvim](https://github.com/rktjmp/hotpot.nvim)

这部分聚焦于 Neovim 生态中的 Fennel 开发工作流，当前已包含 Hotpot 的核心文档翻译，后续也会继续在该目录补充更多 Fennel 相关内容。

- [Hotpot README 翻译](hotpot/hotpot_nvim_readme.md) - 插件介绍、安装、配置、命令与迁移说明
- [Hotpot 帮助文档翻译](hotpot/hotpot_nvim_docs_hotpot_txt.md) - 面向 Neovim help 格式的完整章节导航
